# Simple Face Recognition Test - No Emoji Version
import cv2
import os
import numpy as np
...
def test_face_detection():
    ...
    if cap.isOpened():
        ...
        if ret:
            ...
            # Save image
            filename = f"test_face_{datetime.now().strftime('%H%M%S')}.jpg"
    ...
    print("\n" + "=" * 40)
    print("HOW TO USE:")
    print("1. Make sure you have a webcam")
    print("2. Run: python simple_face_test.py")  
    print("3. Check saved image for face detection")
    print("=" * 40)

def create_face_demo():
    """
    Create a simple demo file for face detection
    """
    demo_content = '''# Face Recognition Demo - Simple Version
...
'''
    ...
    with open('face_demo.py', 'w', encoding='utf-8') as f:
        f.write(demo_content)
    
    print("Created: face_demo.py")
...
if __name__ == "__main__":
    ...
    print("\nNext: Run 'python face_demo.py' for interactive demo")
